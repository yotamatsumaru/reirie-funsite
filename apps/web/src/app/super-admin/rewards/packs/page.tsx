/**
 * /super-admin/rewards/packs — 特典ポイントパック管理
 */
...
export const metadata: Metadata = { title: '特典ポイントパック管理' };
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h1 className="text-xl font-bold text-slate-800 sm:text-2xl">特典ポイントパック管理</h1>
          <p className="mt-1 text-sm text-slate-500">
            Stripe決済で購入できる特典ポイントパックを管理します。
          </p>
        </div>
          ...
          <Card key={p.id}>
            <CardBody className="space-y-2">
              ...
              <div className="flex flex-wrap gap-1.5 text-xs">
                ...
                <span className="text-xs text-slate-600">{p.points.toLocaleString()}pt</span>
        ...
        <table className="w-full text-sm">
          <thead className="bg-slate-50 text-left text-xs text-slate-500">
            <tr>
              ...
              <th className="px-4 py-2 text-right">付与pt</th>
