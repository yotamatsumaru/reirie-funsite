 ...
 *
 * 勝率 / 特典ポイントボーナス / キャラボイス / キャラクター画像 / サムネイル を集約する
...
export default async function AcchiGameSettingsPage() {
  const [acchiSettings, acchiRewardBonusSettings, gameAudio, characterImages, siteImages] =
    await Promise.all([
      getAcchiWinSettings(),
    ...
    <main>
      <header className="mb-5">
        ...
        <p className="mt-1 text-sm text-slate-500">
          勝率・特典ボーナス・キャラボイス・キャラクター画像・サムネイルの設定。
